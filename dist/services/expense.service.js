...
export async function deleteExpenseById(id) {
    ...
    if (!expense)
        throw new AppError("Expense not found", 404, "No expense found with the given ID");
...
export async function getExpenseById(userId) {
...
export async function updateExpense(id, updatedData) {
    ...
    if (!expense)
        throw new AppError("Expense not found", 404, "Ne expense found with the given ID");
